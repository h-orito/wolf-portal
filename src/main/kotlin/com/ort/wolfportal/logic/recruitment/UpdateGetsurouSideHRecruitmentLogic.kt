...
@Component
class UpdateGetsurouSideHRecruitmentLogic(
    val logic: GetsurouScrapingLogic,
    val slackLogic: SlackLogic
) : AbstractUpdateRecruitmentLogic() {

    private val logger = LoggerFactory.getLogger(UpdateGetsurouSideHRecruitmentLogic::class.java)
    private val url = "https://marchocias.xsrv.jp/sow.cgi"
