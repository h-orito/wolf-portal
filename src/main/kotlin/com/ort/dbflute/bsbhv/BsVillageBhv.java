...
public abstract class BsVillageBhv extends AbstractBehaviorWritable<Village, VillageCB> {
     ...
     * <pre>
     * <span style="color: #0000C0">villageBhv</span>.<span style="color: #CC4747">loadVillagePlayerStats</span>(<span style="color: #553000">villageList</span>, <span style="color: #553000">statsCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public NestedReferrerListGateway<VillagePlayerStats> loadVillagePlayerStats(List<Village> villageList, ReferrerConditionSetupper<VillagePlayerStatsCB> refCBLambda) {
        xassLRArg(villageList, refCBLambda);
        return doLoadVillagePlayerStats(villageList, new LoadReferrerOption<VillagePlayerStatsCB, VillagePlayerStats>().xinit(refCBLambda));
    }
     ...
     * VILLAGE_PLAYER_STATS by VILLAGE_ID, named 'villagePlayerStatsList'.
     * <pre>
     * <span style="color: #0000C0">villageBhv</span>.<span style="color: #CC4747">loadVillagePlayerStats</span>(<span style="color: #553000">village</span>, <span style="color: #553000">statsCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">statsCB</span>.setupSelect...
     *     <span style="color: #553000">statsCB</span>.query().set...
     *     <span style="color: #553000">statsCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">village</span>.<span style="color: #CC4747">getVillagePlayerStatsList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<VillagePlayerStats> loadVillagePlayerStats(Village village, ReferrerConditionSetupper<VillagePlayerStatsCB> refCBLambda) {
        xassLRArg(village, refCBLambda);
        return doLoadVillagePlayerStats(xnewLRLs(village), new LoadReferrerOption<VillagePlayerStatsCB, VillagePlayerStats>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<VillagePlayerStats> doLoadVillagePlayerStats(List<Village> villageList, LoadReferrerOption<VillagePlayerStatsCB, VillagePlayerStats> option) {
        return helpLoadReferrerInternally(villageList, option, "villagePlayerStatsList");
    }
     ...
     */
    public List<Country> pulloutCountry(List<Village> villageList)
    { return helpPulloutInternally(villageList, "country"); }
