...
public abstract class BsPlayerBhv extends AbstractBehaviorWritable<Player, PlayerCB> {
     ...
     * <pre>
     * <span style="color: #0000C0">playerBhv</span>.<span style="color: #CC4747">loadCountryPlayer</span>(<span style="color: #553000">playerList</span>, <span style="color: #553000">playerCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public NestedReferrerListGateway<CountryPlayer> loadCountryPlayer(List<Player> playerList, ReferrerConditionSetupper<CountryPlayerCB> refCBLambda) {
        xassLRArg(playerList, refCBLambda);
        return doLoadCountryPlayer(playerList, new LoadReferrerOption<CountryPlayerCB, CountryPlayer>().xinit(refCBLambda));
    }
     ...
     * COUNTRY_PLAYER by PLAYER_ID, named 'countryPlayerList'.
     * <pre>
     * <span style="color: #0000C0">playerBhv</span>.<span style="color: #CC4747">loadCountryPlayer</span>(<span style="color: #553000">player</span>, <span style="color: #553000">playerCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">playerCB</span>.setupSelect...
     *     <span style="color: #553000">playerCB</span>.query().set...
     *     <span style="color: #553000">playerCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">player</span>.<span style="color: #CC4747">getCountryPlayerList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<CountryPlayer> loadCountryPlayer(Player player, ReferrerConditionSetupper<CountryPlayerCB> refCBLambda) {
        xassLRArg(player, refCBLambda);
        return doLoadCountryPlayer(xnewLRLs(player), new LoadReferrerOption<CountryPlayerCB, CountryPlayer>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<CountryPlayer> doLoadCountryPlayer(List<Player> playerList, LoadReferrerOption<CountryPlayerCB, CountryPlayer> option) {
        return helpLoadReferrerInternally(playerList, option, "countryPlayerList");
    }
