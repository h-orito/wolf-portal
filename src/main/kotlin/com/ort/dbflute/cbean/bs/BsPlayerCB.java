...
public class BsPlayerCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<PlayerCQ> {
         ...
         */
        public HpSDRFunction<CountryPlayerCB, PlayerCQ> derivedCountryPlayer() {
            assertDerived("countryPlayerList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<CountryPlayerCB> sq, PlayerCQ cq, String al, DerivedReferrerOption op)
