...
public class BsVillageCB extends AbstractConditionBean {
     ...
     *     ... = <span style="color: #553000">village</span>.<span style="color: #CC4747">getCountry()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<VillageCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnVillageName() { return doColumn("VILLAGE_NAME"); }
        /**
         * VILLAGE_NO: {NotNull, INT UNSIGNED(10)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnVillageNo() { return doColumn("VILLAGE_NO"); }
        /**
         * VILLAGE_URL: {NotNull, VARCHAR(255)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnVillageUrl() { return doColumn("VILLAGE_URL"); }
        /**
         * VILLAGE_START_DATETIME: {DATETIME(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnVillageStartDatetime() { return doColumn("VILLAGE_START_DATETIME"); }
        /**
         * VILLAGE_END_DATETIME: {DATETIME(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnVillageEndDatetime() { return doColumn("VILLAGE_END_DATETIME"); }
        /**
         * WIN_CAMP_NAME: {VARCHAR(255)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnWinCampName() { return doColumn("WIN_CAMP_NAME"); }
        /**
         ...
         */
        public HpSDRFunction<VillagePlayerStatsCB, VillageCQ> derivedVillagePlayerStats() {
            assertDerived("villagePlayerStatsList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<VillagePlayerStatsCB> sq, VillageCQ cq, String al, DerivedReferrerOption op)
