...
public abstract class AbstractBsPlayerCQ extends AbstractConditionQuery {
     ...
     * {exists (select PLAYER_ID from country_player where ...)} <br>
     * country_player by PLAYER_ID, named 'countryPlayerAsOne'.
     * <pre>
    ...
    public void existsCountryPlayer(SubQuery<CountryPlayerCB> subCBLambda) {
        ...
        lockCall(() -> subCBLambda.query(cb)); String pp = keepPlayerId_ExistsReferrer_CountryPlayerList(cb.query());
        registerExistsReferrer(cb.query(), "PLAYER_ID", "PLAYER_ID", pp, "countryPlayerList");
    }
    public abstract String keepPlayerId_ExistsReferrer_CountryPlayerList(CountryPlayerCQ sq);

    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select PLAYER_ID from country_player where ...)} <br>
     * country_player by PLAYER_ID, named 'countryPlayerAsOne'.
     * <pre>
     ...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of PlayerId_NotExistsReferrer_CountryPlayerList for 'not exists'. (NotNull)
     */
    public void notExistsCountryPlayer(SubQuery<CountryPlayerCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        CountryPlayerCB cb = new CountryPlayerCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepPlayerId_NotExistsReferrer_CountryPlayerList(cb.query());
        registerNotExistsReferrer(cb.query(), "PLAYER_ID", "PLAYER_ID", pp, "countryPlayerList");
    }
    public abstract String keepPlayerId_NotExistsReferrer_CountryPlayerList(CountryPlayerCQ sq);
    ...
    public void xsderiveCountryPlayerList(String fn, SubQuery<CountryPlayerCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepPlayerId_SpecifyDerivedReferrer_CountryPlayerList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "PLAYER_ID", "PLAYER_ID", pp, "countryPlayerList", al, op);
    }
    public abstract String keepPlayerId_SpecifyDerivedReferrer_CountryPlayerList(CountryPlayerCQ sq);
    ...
    public void xqderiveCountryPlayerList(String fn, SubQuery<CountryPlayerCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        CountryPlayerCB cb = new CountryPlayerCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepPlayerId_QueryDerivedReferrer_CountryPlayerList(cb.query()); String prpp = keepPlayerId_QueryDerivedReferrer_CountryPlayerListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "PLAYER_ID", "PLAYER_ID", sqpp, "countryPlayerList", rd, vl, prpp, op);
    }
    public abstract String keepPlayerId_QueryDerivedReferrer_CountryPlayerList(CountryPlayerCQ sq);
    public abstract String keepPlayerId_QueryDerivedReferrer_CountryPlayerListParameter(Object vl);
