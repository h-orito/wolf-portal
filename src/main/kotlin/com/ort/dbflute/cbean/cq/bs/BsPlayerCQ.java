...
public class BsPlayerCQ extends AbstractBsPlayerCQ {
    ...
    public Map<String, CountryPlayerCQ> xdfgetPlayerId_ExistsReferrer_CountryPlayerList() { return xgetSQueMap("playerId_ExistsReferrer_CountryPlayerList"); }
    public String keepPlayerId_ExistsReferrer_CountryPlayerList(CountryPlayerCQ sq) { return xkeepSQue("playerId_ExistsReferrer_CountryPlayerList", sq); }

    public Map<String, CountryPlayerCQ> xdfgetPlayerId_NotExistsReferrer_CountryPlayerList() { return xgetSQueMap("playerId_NotExistsReferrer_CountryPlayerList"); }
    public String keepPlayerId_NotExistsReferrer_CountryPlayerList(CountryPlayerCQ sq) { return xkeepSQue("playerId_NotExistsReferrer_CountryPlayerList", sq); }

    public Map<String, CountryPlayerCQ> xdfgetPlayerId_SpecifyDerivedReferrer_CountryPlayerList() { return xgetSQueMap("playerId_SpecifyDerivedReferrer_CountryPlayerList"); }
    public String keepPlayerId_SpecifyDerivedReferrer_CountryPlayerList(CountryPlayerCQ sq) { return xkeepSQue("playerId_SpecifyDerivedReferrer_CountryPlayerList", sq); }

    public Map<String, CountryPlayerCQ> xdfgetPlayerId_QueryDerivedReferrer_CountryPlayerList() { return xgetSQueMap("playerId_QueryDerivedReferrer_CountryPlayerList"); }
    public String keepPlayerId_QueryDerivedReferrer_CountryPlayerList(CountryPlayerCQ sq) { return xkeepSQue("playerId_QueryDerivedReferrer_CountryPlayerList", sq); }
    public Map<String, Object> xdfgetPlayerId_QueryDerivedReferrer_CountryPlayerListParameter() { return xgetSQuePmMap("playerId_QueryDerivedReferrer_CountryPlayerList"); }
    public String keepPlayerId_QueryDerivedReferrer_CountryPlayerListParameter(Object pm) { return xkeepSQuePm("playerId_QueryDerivedReferrer_CountryPlayerList", pm); }
