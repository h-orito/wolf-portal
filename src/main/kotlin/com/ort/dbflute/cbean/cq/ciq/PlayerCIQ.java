...
public class PlayerCIQ extends AbstractBsPlayerCQ {
    ...
    public String keepPlayerId_ExistsReferrer_CountryPlayerList(CountryPlayerCQ sq)
    { throwIICBOE("ExistsReferrer"); return null; }
    public String keepPlayerId_NotExistsReferrer_CountryPlayerList(CountryPlayerCQ sq)
    { throwIICBOE("NotExistsReferrer"); return null; }
    public String keepPlayerId_SpecifyDerivedReferrer_CountryPlayerList(CountryPlayerCQ sq)
    { throwIICBOE("(Specify)DerivedReferrer"); return null; }
    public String keepPlayerId_QueryDerivedReferrer_CountryPlayerList(CountryPlayerCQ sq)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepPlayerId_QueryDerivedReferrer_CountryPlayerListParameter(Object vl)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
