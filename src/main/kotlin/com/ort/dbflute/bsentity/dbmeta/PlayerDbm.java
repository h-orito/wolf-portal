...
public class PlayerDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPlayerId = cci("PLAYER_ID", "PLAYER_ID", null, null, Integer.class, "playerId", null, true, true, true, "INT UNSIGNED", 10, 0, null, null, false, null, null, null, "countryPlayerList", null, false);
    ...
    public ReferrerInfo referrerCountryPlayerList() {
        Map<ColumnInfo, ColumnInfo> mp = newLinkedHashMap(columnPlayerId(), CountryPlayerDbm.getInstance().columnPlayerId());
        return cri("FK_COUNTRY_PLAYER_PLAYER", "countryPlayerList", this, CountryPlayerDbm.getInstance(), mp, false, "player");
    }
