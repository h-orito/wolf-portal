...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("country", "com.ort.dbflute.bsentity.dbmeta.CountryDbm");
        tmpMap.put("country_player", "com.ort.dbflute.bsentity.dbmeta.CountryPlayerDbm");
        tmpMap.put("country_progress", "com.ort.dbflute.bsentity.dbmeta.CountryProgressDbm");
        tmpMap.put("country_progress_detail", "com.ort.dbflute.bsentity.dbmeta.CountryProgressDetailDbm");
        tmpMap.put("country_recruitment", "com.ort.dbflute.bsentity.dbmeta.CountryRecruitmentDbm");
        tmpMap.put("country_recruitment_detail", "com.ort.dbflute.bsentity.dbmeta.CountryRecruitmentDetailDbm");
        tmpMap.put("player", "com.ort.dbflute.bsentity.dbmeta.PlayerDbm");
        tmpMap.put("recruit_stats", "com.ort.dbflute.bsentity.dbmeta.RecruitStatsDbm");
        tmpMap.put("village", "com.ort.dbflute.bsentity.dbmeta.VillageDbm");
        tmpMap.put("village_player_stats", "com.ort.dbflute.bsentity.dbmeta.VillagePlayerStatsDbm");
